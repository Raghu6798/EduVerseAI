...
export const ChatInterface = ({ mode }: { mode: string }) => {
  ...
  const validateAndUpload = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.VITE_API_BASE_URL}/api/v1/upload`, formData, {
        headers: {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${process.env.VITE_API_BASE_URL}/api/v1/query`,
        {
          question: input,
  ...
  const handleImageUpload = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${process.env.VITE_API_BASE_URL}/image-qa/upload`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleImageAsk = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${process.env.VITE_API_BASE_URL}/image-qa/ask`,
        {
          image_id: imageId,
  ...
  const handleVideoFileUpload = async () => {
    ...
    try {
      ...
      const res = await axios.post(`${process.env.VITE_API_BASE_URL}/video-qa/upload-video`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleYoutubeUrlSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const token = supabaseSession?.access_token
      const res = await fetch(`${process.env.VITE_API_BASE_URL}/video-qa/process-youtube`, {
        method: "POST",
        headers: {
